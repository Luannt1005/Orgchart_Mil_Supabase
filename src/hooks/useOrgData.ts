...
const DEDUPING_INTERVAL = 15 * 60 * 1000; // 15 minutes - keep cache active for this duration
const FOCUS_THROTTLE_INTERVAL = 15 * 60 * 1000; // 15 minutes - don't revalidate when focusing tab
